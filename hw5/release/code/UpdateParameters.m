...
% W{end} = W{end} - 100.0*learning_rate*grad_W{end};
% b{end} = b{end} - 100.0*learning_rate*grad_b{end};
W{end} = W{end} - learning_rate*grad_W{end};
b{end} = b{end} - learning_rate*grad_b{end};
